...
func (s *redeemZcTokenTest) SetupTest() {
	var err error
...
func (s *redeemZcTokenTest) TestRedeemVaultInterest() {
...
func (s *redeemZcTokenTest) TestRedeemVaultInterestRedeemUnderlyingFails() {
	assert := assertions.New(s.T())
	maturity := s.Dep.Maturity
	ctokenAddr := s.Dep.CErc20Address
...
func (s *redeemZcTokenTest) TestRedeemVaultInterestTransferFails() {
	assert := assertions.New(s.T())
	maturity := s.Dep.Maturity
	ctokenAddr := s.Dep.CErc20Address
...
func TestRedeemZcTokenTest(t *test.T) {
