...
type addNotionalNotMaturedSuite struct {
	suite.Suite
	Env          *Env
	Dep          *Dep
...
func (s *addNotionalNotMaturedSuite) SetupSuite() {
	var err error
...
func (s *addNotionalNotMaturedSuite) TestAddNotional() {
...
func TestAddNotionalNotMaturedSuite(t *test.T) {
	suite.Run(t, &addNotionalNotMaturedSuite{})
}
