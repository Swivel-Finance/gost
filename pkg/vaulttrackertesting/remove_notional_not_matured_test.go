...
type trackerRemoveNotionalNotMaturedSuite struct {
	suite.Suite
	Env          *Env
	Dep          *Dep
...
func (s *trackerRemoveNotionalNotMaturedSuite) SetupSuite() {
	var err error
...
func (s *trackerRemoveNotionalNotMaturedSuite) TestRemoveNotionalNotMatured() {
...
func TestTrackerRemoveNotionalNotMaturedSuite(t *test.T) {
	suite.Run(t, &trackerRemoveNotionalNotMaturedSuite{})
}
