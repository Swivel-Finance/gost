...
type trackerRemoveNotionalMaturedSuite struct {
	suite.Suite
	Env          *Env
	Dep          *Dep
...
func (s *trackerRemoveNotionalMaturedSuite) SetupSuite() {
	var err error
...
func (s *trackerRemoveNotionalMaturedSuite) TestRemoveNotionalMatured() {
...
func TestTrackerRemoveNotionalMaturedSuite(t *test.T) {
	suite.Run(t, &trackerRemoveNotionalMaturedSuite{})
}
