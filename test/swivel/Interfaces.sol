...
// NOTE this example being of narrow interfaces for individual protocols
// TODO it may be possible to have something wider like
// IMint and IDeposit, but unsure where that puts things like `redeemUnderlying`
// NOTE this is likely the same deployed adapter whose PROTOCOL = 0 (Compound), thus likely is ICompounding as well...
interface ICompound {
