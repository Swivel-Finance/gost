...
contract MarketPlace {
  ...
  function mintZcTokenAddingNotional(address u, uint256 m, address t, uint256 a) external authorized(swivel) returns (bool) {
  ...
  function burnZcTokenRemovingNotional(address u, uint256 m, address t, uint256 a) external authorized(swivel) returns(bool) {
  ...
  function redeemZcToken(address u, uint256 m, address t, uint256 a) external authorized(swivel) returns (uint256) {
  ...
  /// @param m Maturity timestamp of the market
  /// @param t Address of the redeeming user
  function redeemVaultInterest(address u, uint256 m, address t) external authorized(swivel) returns (uint256) {
  ...
  function custodialInitiate(address u, uint256 m, address z, address n, uint256 a) external authorized(swivel) returns (bool) {
  ...
  function custodialExit(address u, uint256 m, address z, address n, uint256 a) external authorized(swivel) returns (bool) {
  ...
  function p2pZcTokenExchange(address u, uint256 m, address f, address t, uint256 a) external authorized(swivel) returns (bool) {
  ...
  function p2pVaultExchange(address u, uint256 m, address f, address t, uint256 a) external authorized(swivel) returns (bool) {
  ...
  function transferVaultNotional(address u, uint256 m, address t, uint256 a) external returns (bool) {
